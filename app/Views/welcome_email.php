...
<head>
    ...
    <title>FaceOfMoa Welcome Email</title>
    <style type="text/css">
                                    ...
                                    <td align="center" class="" valign="top">
                                        ...
                                        <table bgcolor="#fff" cellpadding="0" cellspacing="0" class="" style="margin: 0 auto; width: 100%; margin-top: 100px;">
                                            <tbody style="margin-top: 15px;">
                                                ...
                                                <tr class="">
                                                    <td class="headline">Welcome to FaceOfMoa!</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <center class="">
                                                                ...
                                                                <tbody class="">
                                                                    <tr class="">
                                                                        <td class="" style="color:#444; font-weight: 400;"><br><br>
                                                                            ...
                                                                            You have successfully been registered to use FaceOfMoa as a <em>Contestant</em><br>
                                                                            <br>
                                                                            Your login credentials are provided below:
                                                                            <br>
                                                                            <span style="font-weight:bold;">Email: &nbsp;</span><span style="font-weight:lighter;" class=""><?= $email ?></span>
                                                                            <br>
                                                                            <span style="font-weight:bold;">Password: &nbsp;</span><span style="font-weight:lighter;" class=""><?= $user_password ?></span>
                                                                            <br><br>
                                                                            <br>
                                                                        </td>
                                                                    </tr>
