...
<section class=" p-2 col-lg-12">
    ...
    <div class="container shadow shadow-sm p-4 col-lg-10">
        ...
        <form method="post" action="<?= base_url('settings/apikey') ?>" class="  d-flex flex-lg-column col-lg-8 m-4 text-black" enctype="multipart/form-data" id='searchForm'>
            ...
            <div class="  d-flex col-lg-12 m- text-black">
                ...
                <input type="button" name="searchBtn" class="btn btn-block btn-warning" value="submit" onclick="document.getElementById('searchForm').submit();">
        ...
        <form method="post" action="<?= base_url('settings/logo') ?>" id='logo' class="  d-flex flex-lg-column col-lg-8 m-4 text-black" enctype="multipart/form-data" id='searchForm'>
            ...
            <div class="  d-flex col-lg-12 m- text-black">
                <input class="form-control" type="file" accept="image/png, image/gif, image/jpeg ,image/webp" name="logo" required id="formFileMultiple" >
